...
def step():
    ...
    if clicked_node in network.reaction_nodes:
        to_delete = network.delete_reaction_node(clicked_node)
        ...
        task = current_app.retrorules_queue.enqueue(task_add_retrorule_step, form_data, task_id)
        progress = 'queuing'
