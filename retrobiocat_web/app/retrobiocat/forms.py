...
class NetworkExploreForm(FlaskForm):
    ...
    max_initial_nodes = IntegerField('Max initial nodes', default=10, validators=[NumberRange(min=1, max=80)])
    ...
    remove_small = BooleanField('Remove small molecules (eg NH3)')
...
class PathwayExploreForm(FlaskForm):
    ...
    max_pathways = IntegerField('Max pathways', default=40000, validators=[NumberRange(min=100, max=50000)])
    keep_best_pathways = IntegerField('Max pathways', default=2500, validators=[NumberRange(min=50, max=50000)])
