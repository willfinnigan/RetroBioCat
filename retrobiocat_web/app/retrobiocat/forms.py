...
class PathwayExploreForm(FlaskForm):
    ...
    colour_reactions = SelectField('Colour reaction nodes', choices=enzyme_node_choices)
    colour_edges = SelectField('Colour edges', choices=edges_choices)
    max_nodes = IntegerField('Max nodes', default=500, validators=[NumberRange(min=100, max=1000)])
    max_pathways = IntegerField('Max pathways', default=50000, validators=[NumberRange(min=100, max=100000)])
