...
from retrobiocat_web.app.contributions.routes.admin.download_data import reaction_to_yaml_dict
from retrobiocat_web.app.contributions.functions.reaction_rules.reaction_tests import ReactionTester
...
def get_reaction_yaml_dict(reaction_name):
    ...
    yaml_dict = reaction_to_yaml_dict({}, reaction)
    return yaml_dict
